<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 p-4">
    <div class="w-full max-w-md">
      ...
      <!-- Card -->
      <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 relative">

        <!-- Admin Badge -->
        <div class="absolute top-4 right-4 bg-blue-600 text-white text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest shadow">
          Admin
        </div>
        ...
        <div class="flex flex-col items-center mb-7">
          ...
          <h2 class="text-xl font-bold text-gray-700 mt-2">Admin Panel</h2>
          <p class="text-gray-400 text-sm mt-1">Masuk sebagai Administrator</p>
        </div>
        ...
        <p class="text-center text-sm text-gray-500 mt-6">
          <router-link to="/" class="text-blue-600 font-bold hover:underline">← Kembali ke Toko</router-link>
        </p>
      </div>

      <p class="text-center text-white/60 text-xs mt-5">© 2025 Cloudmart. Admin Access Only.</p>
    </div>
  </div>
</template>
